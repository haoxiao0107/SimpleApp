...
import com.hx.simpleapp.base.BaseApplication;
import com.hx.simpleapp.util.LogUtils;
import com.hx.simpleapp.util.OSUtil;
import com.hx.simpleapp.util.SafeUtils;
import com.hx.simpleapp.util.StringUtils;
...
//        Thread.setDefaultUncaughtExceptionHandler(AppCrash.getAppExceptionHandler());
    ...
    public boolean isNoImageMode() {
        boolean isNoImageMode = getPreferences().getBoolean(AppConstant.KEY_MODE_NO_IMAGE, false);
    ...
    public boolean isAutoCacheMode() {
        boolean isAutoCacheMode = getPreferences().getBoolean(AppConstant.KEY_MODE_AUTO_CACHE, false);
        return isAutoCacheMode;
    }
}
